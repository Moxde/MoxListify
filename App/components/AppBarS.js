...
// Appbar für die Seiten der App mit dem Logo und dem Namen der Seite
    ...
    <View style={style.mainCont}>
      <View style={style.cont}>
        <TouchableOpacity
          ...
          accessible={true}
          accessibilityLabel="Zurück zur Startseite"></TouchableOpacity>
        <TouchableOpacity
          onPress={() => navigation.navigate('Home')}
          accessible={true}
      ...
      <View style={style.cont1}>
        <Text style={style.mainText}>{scName}</Text>
      </View>
    </View>
  );
}
